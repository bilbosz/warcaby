...
namespace Resources
{
    ...
    const sf::Color InfoTextColor(sf::Color::Blue), 
		BannerTextColor(sf::Color::Black),
    ...
    const unsigned int BannerCharacterSize(85U);

    const std::string GameTitle("Warcaby");
    ...
    const float WindowDesktopWidthRatio(1f),
		WindowDesktopHeightRatio(1f);
#endif
